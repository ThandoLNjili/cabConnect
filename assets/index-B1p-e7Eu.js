 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZA(r){r=mn(r,ht);const e=mn(r.firestore,mr),n=Kh(e);return dD(n,r._key).then((s=>WA(e,r,s)))}function xD(r){r=mn(r,ds);const e=mn(r.firestore,mr),n=Kh(e),s=new Kp(e);return QA(r._query),mD(n,r._query).then((l=>new Xs(e,s,r,l)))}function VD(r,e,n){r=mn(r,ht);const s=mn(r.firestore,mr),l=JA(r.converter,e),u=Qh(s);return Jh(s,[qA(u,"setDoc",r._key,l,r.converter!==null,n).toMutation(r._key,Hn.none())])}function wh(r,e,n,...s){r=mn(r,ht);const l=mn(r.firestore,mr),u=Qh(l);let f;return f=typeof(e=yt(e))=="string"||e instanceof qp?wD(u,"updateDoc",r._key,e,n,s):bD(u,"updateDoc",r._key,e),Jh(l,[f.toMutation(r._key,Hn.exists(!0))])}function MD(r){return Jh(mn(r.firestore,mr),[new Tp(r._key,Hn.none())])}function kD(r,e){const n=mn(r.firestore,mr),s=Mi(r),l=JA(r.converter,e),u=Qh(r.firestore);return Jh(n,[qA(u,"addDoc",s._key,l,r.converter!==null,{}).toMutation(s._key,Hn.exists(!1))]).then((()=>s))}function $m(r,...e){var g,T,S;r=yt(r);let n={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||l0(e[s])||(n=e[s++]);const l={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(l0(e[s])){const b=e[s];e[s]=(g=b.next)==null?void 0:g.bind(b),e[s+1]=(T=b.error)==null?void 0:T.bind(b),e[s+2]=(S=b.complete)==null?void 0:S.bind(b)}let u,f,p;if(r instanceof ht)f=mn(r.firestore,mr),p=Lh(r._key.path),u={next:b=>{e[s]&&e[s](WA(f,r,b))},error:e[s+1],complete:e[s+2]};else{const b=mn(r,ds);f=mn(b.firestore,mr),p=b._query;const q=new Kp(f);u={next:Z=>{e[s]&&e[s](new Xs(f,q,b,Z))},error:e[s+1],complete:e[s+2]},QA(r._query)}const y=Kh(f);return fD(y,p,l,u)}function Jh(r,e){const n=Kh(r);return pD(n,e)}function WA(r,e,n){const s=n.docs.get(e._key),l=new Kp(r);return new Qs(r,l,e._key,s,new Ll(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){d2(yo),Li(new ri("firestore",((s,{instanceIdentifier:l,options:u})=>{const f=s.getProvider("app").getImmediate(),p=new mr(new g2(s.getProvider("auth-internal")),new v2(f,s.getProvider("app-check-internal")),L2(f,l),f);return u={useFetchStreams:n,...u},p._setSettings(u),p}),"PUBLIC").setMultipleInstances(!0)),qn(a0,o0,e),qn(a0,o0,"esm2020")})();const eS="@firebase/installations",Jp="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function t4(r,e){const n=e.data;if(!n.isFirebaseMessaging)return;r.onMessageHandler&&n.messageType===eu.PUSH_RECEIVED&&(typeof r.onMessageHandler=="function"?r.onMessageHandler(y0(n)):r.onMessageHandler.next(y0(n)));const s=n.data;KO(s)&&s[RO]==="1"&&await WO(r,n.messageType,s)}const _0="@firebase/messaging",v0="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n4=r=>{const e=new QO(r.getProvider("app").getImmediate(),r.getProvider("installations-internal").getImmediate(),r.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>t4(e,n)),e},i4=r=>{const e=r.getProvider("messaging").getImmediate();return{getToken:s=>SS(e,s)}};function r4(){Li(new ri("messaging",n4,"PUBLIC")),Li(new ri("messaging-internal",i4,"PRIVATE")),qn(_0,v0),qn(_0,v0,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function s4(){try{await k0()}catch{return!1}return typeof window<"u"&&M0()&&U1()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function a4(r=ip()){return s4().then(e=>{if(!e)throw rn.create("unsupported-browser")},e=>{throw rn.create("indexed-db-unsupported")}),go(yt(r),"messaging").getImmediate()}async function o4(r,e){return r=yt(r),SS(r,e)}r4();var l4="firebase",u4="12.9.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qn(l4,u4,"app");const c4={apiKey:"AIzaSyCNQaTYYDvt-ETlEZ7b8CiK1QG4vGynJDo",authDomain:"cabconnect-b75f6.firebaseapp.com",projectId:"cabconnect-b75f6",storageBucket:"cabconnect-b75f6.firebasestorage.app",messagingSenderId:"837263009325",appId:"1:837263009325:web:10336c1678738b6a593aa4",measurementId:"G-FPY7FZKFX4"},rg=U0(c4),wn=vD(rg,"cabconnect"),Rn=h2(rg),h4=a4(rg),f4="BNbalcEHKDYuy5PgNYsGCe7oEPxNg1RCe3QVfus4FfuRNGvw0RehK8T_YK7K-k8twZxwtR9VqTM0zpO5WWguXwE";async function d4(){try{if(typeof Notification<"u"&&await Notification.requestPermission()!=="granted"){console.warn("Notifications permission not granted");return}const r=await navigator.serviceWorker.register("/cabConnect/firebase-messaging-sw.js",{scope:"/cabConnect/"}),e=await o4(h4,{vapidKey:f4,serviceWorkerRegistration:r});e&&Rn.currentUser&&await wh(Mi(wn,"users",Rn.currentUser.uid),{fcmToken:e})}catch(r){console.error("Failed to register FCM token:",r)}}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const m4=r=>r.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase();/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p4=r=>r.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,n,s)=>s?s.toUpperCase():n.toLowerCase());/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E0=r=>{const e=p4(r);return e.charAt(0).toUpperCase()+e.slice(1)};/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
